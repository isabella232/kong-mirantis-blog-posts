...
Mirantis Container Runtime (MCR) Installation	3
Install utilities	3
Install Mirantis Container Runtime	3
Portainer installation	5
Mirantis Kubernetes Engine (MKE) Installation	7
MKE installation	7
Mirantis Kubernetes Engine Web UI	10
Mirantis Secure Registry (MSR)	12
Install utilities	12
Install Mirantis Container Runtime	12
Portainer installation	14
Connection testing	15
Add MSR to MKE	15
Mirantis Secure Registry installation	17
Private Repository setting	21
Kong Enterprise Docker Images	22
Register MSR as an insecure-registry	22
Kong Enterprise and Mirantis Secure Registry	24
Push Kong Enterprise to MSR	25
Kong Enterprise installation - CLI	29
Login to MSR	29
Pull Kong Enterprise image from MSR	29
Tag the local image	29
Create a PostgreSQL container	29
Define the KONG_LICENSE_DATA env variable	29
Create a Docker network	30
Bootstrap the PostgreSQL database:	30
Start the Kong Enterprise container:	30
Test the installation	31
Kong Enterprise installation - Docker Compose	32
Create Kong Enterprise Docker Compose file	32
Create Kong Enterprise Docker Compose Stack	34
Check Kong Enterprise deployment	35
Delete Kong Enterprise deployment	37
Kong Enterprise Service, Route and Plugins	38
Create a Service	38
Create a Route	40
Consume the Route	43
Apply the Rate Limiting Plugin to the Route	44
Consume the Route again	47
Kong for Kubernetes Ingress Controller	49
Install kubectl on MKE host	49
Install Helm on MKE host	49
Download MKE Client Bundle	49
Testing the connection	50
Install Kong for Kubernetes	50
Check the installation	51
Check the Kong Proxy	53
Sample App Installation	55
Ingresses and Policies	57
Create a Service and a Route using CRDs	57
Checking the Ingress	57
Testing the Ingress	58
K4K8S - Rate Limiting Policy Definition	59
Create the plugin	59
Check the plugin	59
Apply the plugin to the route	60
Deleting the annotation	61
Test the plugin	61
K4K8S - API Key Policy Definition	63
Create the plugin	63
Check the plugin	63
Apply the plugin to the route	64
Test the plugin	64
Provisioning a Key	65
Creating a Consumer with the Key	65
Check the Consumer	65
Consume the route with the API Key	66
Getting the Rate Limiting error	67
